...
```{r echo=FALSE, out.width="75%", out.height="75%", fig.cap = "Two and Three Point percentage by Position", fig.align = 'center', fig.pos = 'H'}
...
```{r echo=FALSE, out.width="75%", out.height="75%", fig.cap = "Assists by Position and Player", fig.align = 'center', fig.pos = 'H'}
...
```{r echo=FALSE, out.width="75%", out.height="75%", fig.cap = "Points by Position and Player", fig.align = 'center', fig.pos = 'H'}
...
summary(lm.salary)
lm.predicted <- predict(lm.salary, test.data, type = 'response')
auc(test.data$log_salary, lm.predicted)
```

```{r}
lm.salary.sig <- lm(log_salary ~ G + FTPerc + AST + BLK, data = train.data)
summary(lm.salary.sig)
lm.predicted.sig <- predict(lm.salary.sig, test.data, type = 'response')
auc(test.data$log_salary, lm.predicted.sig)
```
